...
wget -O /etc/systemd/system/ws-dropbear.service https://raw.githubusercontent.com/YINNSTORE/V17/main/sshws/service-wsdropbear && chmod +x /etc/systemd/system/ws-dropbear.service

#System SSL/TLS Websocket-SSH Python
wget -O /etc/systemd/system/ws-stunnel.service https://raw.githubusercontent.com/YINNSTORE/V17/main/sshws/ws-stunnel.service && chmod +x /etc/systemd/system/ws-stunnel.service
